...
class Bike(models.Model):
    ...
    tyres_type = models.CharField(choices=tyres_types)
    wheels_type = models.CharField(choices=wheels_types)
    previous_owners = models.IntegerField()
    description = RichTextField(max_length=2000)
    division = models.CharField(choices=divisions)
    district = models.CharField(choices=districts)
